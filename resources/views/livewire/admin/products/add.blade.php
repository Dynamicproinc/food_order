                ...
                <div class="rounded border bg-white shadow mb-3">
                    ...
                    @if (count($options) > 0)
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th scope="row">{{ \App\Models\Options::where('id', $item['option_id'])->first()?->option_name }}</th>
                                <td>{{ $item['variant'] }}</td>
                                <td>{{ $item['price'] }}</td>
                                
                                <td><button class="btn btn-defalut" type="button" wire:click="removeOptions({{ $index }})">Remove</button></td>
                            </tr>
                            @endforeach
                ...
                <div class="rounded border bg-white shadow mb-3">
                    <div class="p-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-3">
                               <button class="btn btn-outline-primary btn-lg fw-bolder" type="button" wire:click="addAddons">{{ __('ADD') }}</button>
                            </div>
                        </div>
                    </div>
                    @if(count($choices) >0)
                    <table class="table">
                        ...
                        <tbody>
                            @foreach ($choices as $index => $item )
                                ...
                                {{-- <td>0.00</td> --}}
                                <td>{{ $item['price'] }}</td>
                                <td><button class="btn btn-defalut" wire:click="removeAddons({{ $index }})" type="button">Remove</button></td>
                            </tr> 
                            @endforeach
